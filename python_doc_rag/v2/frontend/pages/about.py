...
## Page Settings ##
st.set_page_config(
    page_title="Homepage", layout="wide", initial_sidebar_state="expanded"
)
...
if sidebar_options == "About the App":
    st.success(
        "###### This is a RAG ChatBot application built using Streamlit, FastAPI for Q&A functionality on python libraries."
    )
